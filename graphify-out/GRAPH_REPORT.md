...
## Corpus Check
- 475 files · ~1,404,487 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3150 nodes · 7662 edges · 177 communities (161 shown, 16 thin omitted)
...
- `GET()` --calls--> `getGuardianDashboard()`  [INFERRED]
  apps/web/src/app/api/v1/resident/dashboard/route.ts → apps/web/src/modules/guardian/guardian.service.ts
- `GET()` --calls--> `listGuardianPayments()`  [INFERRED]
  apps/web/src/app/api/v1/resident/payments/route.ts → apps/web/src/modules/guardian/guardian.service.ts
...
Cohesion: 0.07
Nodes (55): PATCH(), POST(), RouteContext, POST(), POST(), RouteContext, GET(), PATCH() (+47 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (46): GenericPortalScreen(), portalRows(), portalTitle(), PublicHostel, PublicHomePage(), formatHostelAddress(), hasFood(), hostelTypeToUi() (+38 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (49): HostelAdminMaintenancePageContent, currency(), EmptyState(), Input(), LoadingRows(), Panel(), StatusBadge(), HostelAdminReferralsPageContent (+41 more)
...
Cohesion: 0.07
Nodes (37): GET(), POST(), PATCH(), RouteContext, POST(), GET(), GET(), getGuardianDashboard() (+29 more)
...
Cohesion: 0.07
Nodes (41): addEmergencyContact(), addGuardian(), auditResidentAction(), BedRecord, createResident(), definedUpdate(), EmergencyContactCreateInput, EmergencyContactRecord (+33 more)
...
Cohesion: 0.05
Nodes (42): addHostelAdminInquiryNote(), BedCreateInput, BedRecord, BedUpdateInput, comparePublicHostels(), createHostelAdminFloor(), FloorCreateInput, FloorRecord (+34 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (36): AuthServiceError, dispatchOtpChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeOtpIdentifier(), otpDeliveryProvider(), otpRateLimitMax() (+28 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (36): incidentLogSchema, manualStatusOverrideSchema, nightStatusLogSchema, sosAlertSchema, auditSafetyAction(), EmergencyContactRecord, findAdminResident(), NightStatusListQuery (+28 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (22): PATCH(), RouteContext, GET(), POST(), requirePlatformPrincipal(), listListingFlags(), GET(), PATCH() (+14 more)
...
Cohesion: 0.09
Nodes (34): listResidentComplaints(), auditFoodAction(), createFoodMenu(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput, FoodMenuListQuery (+26 more)
...
Cohesion: 0.1
Nodes (26): PATCH(), RouteContext, ratingReviewSchema, reviewModerationLogSchema, auditReviewAction(), createResidentReview(), hideReview(), listPlatformReviews() (+18 more)
...
Cohesion: 0.12
Nodes (23): GET(), GET(), GET(), countByField(), endOfMonth(), getHostelAdminComplaintsReport(), getHostelAdminDashboardReport(), getHostelAdminMaintenanceReport() (+15 more)

### Community 22 - "Community 22"
Cohesion: 0.1
Nodes (31): paymentProofSchema, receiptSchema, approvePaymentProof(), auditPaymentAction(), createPaymentRecord(), definedUpdate(), findAdminPayment(), findAdminPaymentProof() (+23 more)

### Community 23 - "Community 23"
Cohesion: 0.13
Nodes (27): cookieAccessToken(), isRole(), loadApiPrincipal(), errorResponse(), ImageVariantRecord, optimizeImage(), streamToBuffer(), VARIANT_CONFIG (+19 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (25): auditGuardianAction(), createGuardianAccess(), expiresInDays(), findAdminResident(), GuardianAccessCreateInput, GuardianAccessRecord, GuardianLoginInput, GuardianPermissionRecord (+17 more)
...
Cohesion: 0.09
Nodes (26): depositRefundSchema, moveInChecklistSchema, moveOutChecklistSchema, providedItemSchema, auditMoveAction(), createMoveInChecklist(), createMoveOutChecklist(), findAdminResident() (+18 more)
...
Cohesion: 0.12
Nodes (27): ApiFailure, apiRequest(), ApiSuccess, AuthUser, getActivationStatus(), getResidentNightStatus(), listNotifications(), listResidentFood() (+19 more)
...
Cohesion: 0.11
Nodes (25): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, noticeReadStatusSchema, auditNoticeAction(), createNotice() (+17 more)
...
Cohesion: 0.11
Nodes (17): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), readableRole(), CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole() (+9 more)

### Community 38 - "Community 38"
Cohesion: 0.11
Nodes (16): listPayments(), monthSchema, objectIdSchema, paymentCreateSchema, paymentListQuerySchema, paymentProofReviewSchema, paymentProofSubmitSchema, paymentUpdateSchema (+8 more)

### Community 39 - "Community 39"
Cohesion: 0.09
Nodes (17): ApiPrincipal, deviceTokenSchema, notificationSchema, residentSchema, createInAppNotification(), DeviceTokenSaveInput, listNotifications(), markNotificationRead() (+9 more)

### Community 40 - "Community 40"
Cohesion: 0.15
Nodes (21): getCurrentUser(), issueSessionForUser(), login(), logout(), publicUser(), refreshAccessToken(), serviceMocks, session (+13 more)
...
Cohesion: 0.21
Nodes (13): NotificationsPageContent(), field(), LoadState, Message(), NightStatusRow, Notification, optionalNumber(), PageHeader() (+5 more)
...
Cohesion: 0.1
Nodes (21): listHostelAdminRooms(), listHostelAdminRooms(), floorCreateSchema, hostelPhotoCreateSchema, hostelPhotoDeleteQuerySchema, hostelRejectSchema, hostelScopedListQuerySchema, hostelTypeSchema (+13 more)

### Community 49 - "Community 49"
Cohesion: 0.18
Nodes (21): addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelPhotoCreateInput, HostelPhotoDeleteQuery, updateHostelAdminProfile() (+13 more)
...
Cohesion: 0.13
Nodes (19): approvePlatformHostel(), createPlatformHostelApplication(), findHostelByIdOrThrow(), findOrCreatePublicHostelOwner(), getPlatformHostel(), listHostelAdminFloors(), listPlatformHostels(), publishPlatformHostel() (+11 more)
...
Cohesion: 0.25
Nodes (15): POST(), authenticateWithGoogle(), POST(), accessTokenTtlSeconds(), parseDurationSeconds(), refreshTokenTtlSeconds(), isMobileAuthClient(), readBodyRefreshToken() (+7 more)
...
Cohesion: 0.15
Nodes (13): AuthSession, register(), triggerSOS(), verifyOtp(), AppNavigator(), RootStackParamList, Stack, LoginScreen() (+5 more)

### Community 64 - "Community 64"
Cohesion: 0.13
Nodes (13): ComparePage(), hostels, rows, PublicComparePage(), ResidentDashboardPageContent, StatusBadge(), StatusBadgeProps, toneClassName (+5 more)
...
Cohesion: 0.13
Nodes (9): authMocks, request, Role, ROLE_VALUES, hostelMemberSchema, rolePermissionSchema, userSchema, routeMocks (+1 more)
...
Cohesion: 0.2
Nodes (8): foodMenuUpdateSchema, GET(), GET(), PATCH(), RouteContext, ApiError, ApiSuccess, residentListQuerySchema
...
Cohesion: 0.16
Nodes (8): PlatformUsersPageContent(), DashboardCard(), DashboardCardProps, PlatformServiceProvidersPageContent(), PlatformServiceProvidersPageContent, PlatformUsersPageContent, providers, users

### Community 76 - "Community 76"
Cohesion: 0.19
Nodes (10): POST(), foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodPhotoUploadSchema, mealTypeSchema, objectIdSchema, GET() (+2 more)
...
Cohesion: 0.3
Nodes (14): createHostelAdminBed(), createHostelAdminRoom(), findFloorInHostel(), findRoomInHostel(), findScopedInquiry(), normalizeObjectId(), refreshCapacitySummary(), refreshRoomVacancyStatus() (+6 more)
...
Cohesion: 0.18
Nodes (8): createPublicHostelInquiry(), getPublicHostelBySlug(), listHostelAdminInquiries(), listPublicHostels(), serializePublicHostel(), inquiryId, serviceMocks, staffPrincipal
...
Cohesion: 0.2
Nodes (4): emptyFilters, Filters, PublicHostel, PublicHostelsData
...
Cohesion: 0.29
Nodes (5): HostelAdminInquiriesPageContent(), HostelAdminInquiriesPageContent, InquiriesData, Inquiry, InquiryStatus
...
Cohesion: 0.6
Nodes (3): GET(), listApprovedServiceProvidersForHostel(), listPlatformServiceProviders()

### Community 141 - "Community 141"
Cohesion: 0.6
Nodes (5): findVerifiedRegistrationChallenge(), normalizeEmail(), normalizePhone(), registerPublicAccount(), verifyGoogleIdToken()
...
## Knowledge Gaps
- **1127 isolated node(s):** `AuthUser`, `ResidentSummary`, `ApiSuccess`, `ApiFailure`, `Stack` (+1122 more)
...
- **Why does `Role` connect `Community 67` to `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 147`, `Community 21`, `Community 24`, `Community 32`, `Community 36`, `Community 37`, `Community 38`, `Community 40`, `Community 52`, `Community 66`, `Community 72`, `Community 88`, `Community 93`, `Community 120`, `Community 121`, `Community 122`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 0` to `Community 64`, `Community 2`, `Community 35`, `Community 3`, `Community 37`, `Community 70`, `Community 4`, `Community 75`, `Community 43`, `Community 14`, `Community 17`, `Community 92`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 53` to `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 141`, `Community 13`, `Community 15`, `Community 140`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 27`, `Community 29`, `Community 32`, `Community 33`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 48`, `Community 49`, `Community 50`, `Community 54`, `Community 55`, `Community 56`, `Community 81`, `Community 88`?**
