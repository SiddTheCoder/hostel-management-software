# Graph Report - hostel-management-software  (2026-07-22)

## Corpus Check
- 573 files · ~1,489,592 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4430 nodes · 10184 edges · 248 communities (231 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 173 edges (avg confidence: 0.8)
...
1. `handleRouteError()` - 244 edges
2. `successResponse()` - 243 edges
3. `connectToDatabase()` - 160 edges
4. `cn()` - 159 edges
5. `connectToDatabase()` - 142 edges
6. `requireHostelStaffPrincipal()` - 98 edges
7. `browserApi()` - 73 edges
8. `errorResponse()` - 47 edges
9. `requirePlatformPrincipal()` - 44 edges
10. `Panel()` - 43 edges
...
Cohesion: 0.03
Nodes (121): GET(), sendEmail(), addHostelAdminProfilePhoto(), deleteHostelAdminProfilePhoto(), getHostelAdminProfile(), HostelAdminProfileQuery, HostelAdminProfileUpdateInput, HostelPhotoCreateInput (+113 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (86): PATCH(), POST(), RouteContext, GET(), POST(), RouteContext, GET(), POST() (+78 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (96): PagerButton(), iconMap, IconName, NavItem, planCopy, PortalShell(), PortalShellProps, PortalTone (+88 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (62): GenericPortalScreen(), portalRows(), portalTitle(), PublicComparePage(), PublicHostel, CITY_OPTIONS, FACILITY_STATS, HOSTEL_TYPE_STATS (+54 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (42): PlatformAuditLogQueryInput, platformAuditLogQuerySchema, GET(), PATCH(), RouteContext, publishPlatformHostel(), unpublishPlatformHostel(), hostelRejectSchema (+34 more)
...
Cohesion: 0.04
Nodes (43): AuthGuard(), CurrentUser, MeResponse, PortalAccount(), PortalTone, readableRole(), toneBg, toneRing (+35 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (64): listResidentComplaints(), auditFoodAction(), createFoodMenu(), definedUpdate(), FoodFeedbackInput, FoodFeedbackRecord, FoodMenuCreateInput, FoodMenuListQuery (+56 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (46): ReportGrid(), GuardianDashboard, Resident, RoomMapFloor, CreateWardenResult, HostelAdminWardensPage, PERMISSION_LABELS, AUDIT_ACTIVITY (+38 more)
...
Cohesion: 0.06
Nodes (44): POST(), GET(), POST(), getHostelAdminRoomMap(), listHostelAdminFloors(), listHostelAdminRooms(), BedCreateInput, BedRecord (+36 more)
...
Cohesion: 0.08
Nodes (33): csvField(), deferLoad(), DemoDataBadge(), field(), Hostel, HostelTable(), Inquiry, LoadState (+25 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (33): geocodeAndCacheHostel(), HostelGeoRecord, refreshStaleNearbyPlaces(), sleep(), CronAuthResult, normalizeSecret(), safeEqual(), validateCronRequest() (+25 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (39): cookieAccessToken(), isRole(), loadApiPrincipal(), DEFAULT_DOCUMENT_MIME_TYPES, DEFAULT_IMAGE_MIME_TYPES, fileAssetLimits(), mimeList(), positiveInteger() (+31 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (38): dispatchOtpChallenge(), generateOtpCode(), GOOGLE_JWKS, hashOtpCode(), normalizeOtpIdentifier(), otpDeliveryProvider(), otpRateLimitMax(), otpRateLimitWindowMs() (+30 more)
...
Cohesion: 0.06
Nodes (25): HostelAdminMaintenancePageContent, Select(), StatusBadge(), HostelAdminReferralsPageContent, HostelAdminReportsPageContent, HostelAdminServiceProvidersPageContent, field(), HostelAdminMaintenancePageContent() (+17 more)
...
Cohesion: 0.08
Nodes (26): addHostelAdminInquiryNote(), auditInquiryAction(), findScopedInquiry(), HostelAdminInquiryListQuery, HostelAdminInquiryStatusInput, InquiryNoteCreateInput, InquiryNoteRecord, InquiryRecord (+18 more)
...
Cohesion: 0.07
Nodes (22): emergencyContactSchema, incidentLogSchema, manualStatusOverrideSchema, nightStatusSchema, nightStatusLogSchema, sosAlertSchema, EmergencyContactRecord, findAdminResident() (+14 more)
...
Cohesion: 0.18
Nodes (27): field(), ListingFlag, LoadState, MaintenanceRequest, Message(), optionalField(), optionalNumber(), PageHeader() (+19 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (26): referralSchema, referralCodeSchema, referralRewardSchema, auditReferralAction(), confirmReferralJoined(), HostelAdminReferralListQuery, normalizeObjectIds(), referralCodeCandidate() (+18 more)
...
Cohesion: 0.1
Nodes (17): POST(), foodFeedbackSchema, foodMenuCreateSchema, foodMenuListQuerySchema, foodMenuUpdateSchema, foodPhotoUploadSchema, mealTypeSchema, objectIdSchema (+9 more)
...
Cohesion: 0.08
Nodes (22): BedRecord, MaintenanceCommentCreateInput, MaintenanceCommentRecord, MaintenanceHistoryRecord, MaintenanceRequestCreateInput, MaintenanceRequestListQuery, MaintenanceRequestRecord, MaintenanceServiceError (+14 more)
...
Cohesion: 0.11
Nodes (22): assertHostelAccess(), canAccessHostel(), hostelScopedFilter(), TenantAccessError, TenantPrincipal, noticeReadStatusSchema, auditNoticeAction(), definedUpdate() (+14 more)
...
Cohesion: 0.14
Nodes (18): foodFeedbackSchema, maintenanceRequestSchema, paymentProofSchema, countByField(), endOfMonth(), getHostelAdminComplaintsReport(), getHostelAdminDashboardReport(), getHostelAdminMaintenanceReport() (+10 more)

### Community 47 - "Community 47"
Cohesion: 0.12
Nodes (21): ApiFailure, ApiSuccess, AuthUser, getResidentNightStatus(), listResidentFood(), listResidentNotices(), markNoticeAsRead(), ResidentFoodMenu (+13 more)
...
Cohesion: 0.25
Nodes (14): field(), LoadState, Message(), NightStatusRow, Notification, optionalNumber(), PageHeader(), Resident (+6 more)
...
Cohesion: 0.16
Nodes (20): issueSessionForUser(), login(), publicUser(), refreshAccessToken(), AuthTokenPayload, hashToken(), jwtSecret(), PurposeTokenPayload (+12 more)

### Community 64 - "Community 64"
Cohesion: 0.12
Nodes (12): AuditLogRecord, listPlatformAuditLogs(), PlatformAuditLogQuery, RefRecord, mocks, CachedConnection, globalForMongoose, CachedConnection (+4 more)
...
Cohesion: 0.12
Nodes (14): authMocks, request, assertAllowedRole(), AUTHENTICATED_ROLES, hasAllowedRole(), HOSTEL_STAFF_ROLES, PermissionError, PLATFORM_ROLES (+6 more)
...
Cohesion: 0.1
Nodes (15): fromAddress(), SendEmailInput, SendEmailResult, ADMIN_ISSUABLE_ROLES, AdminIssuableRole, generateTemporaryPassword(), HIGH_PRIVILEGE_ROLES, loginUrl() (+7 more)
...
Cohesion: 0.13
Nodes (14): PATCH(), RouteContext, appLoginUrl(), approvePlatformHostel(), monthSchema, objectIdSchema, paymentCreateSchema, paymentListQuerySchema (+6 more)
...
Cohesion: 0.14
Nodes (17): appBaseUrl(), dispatchVerificationEmail(), findVerifiedRegistrationChallenge(), normalizeEmail(), normalizePhone(), registerPublicAccount(), requestPasswordReset(), resendVerificationEmail() (+9 more)
...
Cohesion: 0.1
Nodes (19): Attendance / Night Safety, code:typescript (export enum Role {), code:typescript (interface IQRActivation {), code:typescript (interface INightStatusLog {), code:typescript (interface IRatingReview {), code:typescript (interface IQuestionCallClick {), code:block44 (packages/db/migrations/), Conventions (+11 more)
...
Cohesion: 0.18
Nodes (13): ApiPayload, ApiRequestError, browserApi(), isAuthEndpoint(), parseResponse(), redirectToLogin(), requestUrl(), sendRequest() (+5 more)
...
Cohesion: 0.16
Nodes (12): CurrentUser, DASHBOARD_ROLES, dashboardHrefForRole(), hasDashboard(), MeResponse, moreItems, navItems, PublicHeader() (+4 more)
...
## Knowledge Gaps
- **1669 isolated node(s):** `AuthUser`, `ResidentSummary`, `ApiSuccess`, `ApiFailure`, `Stack` (+1664 more)
...
- **Why does `browserApi()` connect `Community 92` to `Community 3`, `Community 38`, `Community 70`, `Community 8`, `Community 10`, `Community 74`, `Community 11`, `Community 14`, `Community 15`, `Community 48`, `Community 51`, `Community 25`, `Community 21`, `Community 19`, `Community 87`, `Community 121`, `Community 124`, `Community 30`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Role` connect `Community 66` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 13`, `Community 18`, `Community 24`, `Community 26`, `Community 34`, `Community 36`, `Community 42`, `Community 43`, `Community 55`, `Community 61`, `Community 63`, `Community 67`, `Community 68`, `Community 85`, `Community 95`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `connectToDatabase()` connect `Community 9` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 12`, `Community 13`, `Community 16`, `Community 18`, `Community 23`, `Community 24`, `Community 26`, `Community 28`, `Community 31`, `Community 32`, `Community 34`, `Community 36`, `Community 39`, `Community 40`, `Community 42`, `Community 43`, `Community 46`, `Community 49`, `Community 53`, `Community 54`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `Community 72`, `Community 77`, `Community 78`, `Community 85`, `Community 89`, `Community 107`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Are the 137 inferred relationships involving `connectToDatabase()` (e.g. with `POST()` and `listPlatformAuditLogs()`) actually correct?**
  _`connectToDatabase()` has 137 INFERRED edges - model-reasoned connections that need verification._
