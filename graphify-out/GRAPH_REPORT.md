...
## Corpus Check
- 84 files · ~95,920 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 661 nodes · 904 edges · 58 communities (43 shown, 15 thin omitted)
...
3. `Step 1 - Planning + Architecture Lock` - 24 edges
...
Cohesion: 0.09
Nodes (45): AuthServiceError, getCurrentUser(), login(), logout(), publicUser(), refreshAccessToken(), LoginInput, loginSchema (+37 more)
...
Cohesion: 0.07
Nodes (33): ROLE_VALUES, destinationForRole(), isAllowedNextPath(), isSafeLocalPath(), landingPathForRole(), ProtectedRouteRule, protectedRouteRuleForPath(), protectedRouteRules (+25 more)
...
Cohesion: 0.13
Nodes (14): 15. Privacy And Security Lock, 16. Audit Log Lock, 17. Definition Of Done For Any Module, 18. Phase 1 Handoff Checklist, 19. External Decisions Still Needed, 19. User Action Needed Later, 20. Current Phase 0 Result, 21. Current Phase 1 Local Foundation Result (+6 more)
...
## Knowledge Gaps
- **292 isolated node(s):** `eslintConfig`, `nextConfig`, `config`, `dirname`, `email` (+287 more)
...
- **Why does `cn()` connect `Community 5` to `Community 13`, `Community 14`, `Community 18`, `Community 20`, `Community 21`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Phase 4 — Daily Operations + Trust + Safety` connect `Community 6` to `Community 1`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Multi-Hostel SaaS Platform — Phase-Wise Development Plan` connect `Community 7` to `Community 1`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
