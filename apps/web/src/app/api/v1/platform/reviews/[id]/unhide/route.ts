...
import { unhideReview } from "@/modules/reviews/review.service";
...
export async function PATCH(request: NextRequest, context: RouteContext) {
  try {
    ...
    const result = await unhideReview(id, input, principal);

    return successResponse(result, "Review unhidden");
  } catch (error) {
